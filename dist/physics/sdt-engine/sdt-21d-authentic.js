 ...
 */
export function createAuthentic21DState() {
    return {
 ...
 */
export function evolve21DState(state, displacement, pressure, dt) {
...
export class RRPT21D {
    ...
    calculateDisplacement() {
        ...
        return Math.sqrt(this.state.φ[0] ** 2 +
            this.state.φ[1] ** 2 +
            this.state.φ[2] ** 2) * 0.001;
    }
    calculatePressure() {
...
//# sourceMappingURL=sdt-21d-authentic.js.map