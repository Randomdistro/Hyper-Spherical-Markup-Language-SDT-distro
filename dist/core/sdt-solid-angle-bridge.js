...
export class SDTSolidAngleBridge {
    viewingDistance = 650; // mm
    screenWidth;
    screenHeight;
    mappingCache = new Map();
    constructor(screenWidth = window.innerWidth, screenHeight = window.innerHeight, viewingDistance = 650) {
     ...
     */
    sphericalToPixel(sphericalPos, sdtField) {
     ...
     */
    pixelToSpherical(pixelX, pixelY, depth = 1000) {
     ...
     */
    calculatePixelSolidAngle(pixelX, pixelY) {
     ...
     */
    applySDTFieldToSolidAngle(baseMapping, sdtField) {
...
//# sourceMappingURL=sdt-solid-angle-bridge.js.map